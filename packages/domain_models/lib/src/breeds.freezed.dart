...
abstract class $BreedsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? primary, String? secondary, bool? mixed, bool? unknown});
}
...
class _$_Breeds implements _Breeds {
  const _$_Breeds({this.primary, this.secondary, this.mixed, this.unknown});
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, primary, secondary, mixed, unknown);
